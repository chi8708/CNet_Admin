...
namespace CNet.DBUtility
{
	...
	public class DesEncrypt
	{
        ...
        public static string encryption = "CNet948";
        /// <summary>
        /// 加密
        /// </summary>
        ...
        public static string DESDeCode(string pToDecrypt, string sKey)
        {
            try
            {
                ...
                cs.FlushFinalBlock();
                StringBuilder ret = new StringBuilder();
                //  return HttpContextHelper.Current.Server.UrlDecode(System.Text.Encoding.Default.GetString(ms.ToArray()));
