...
namespace CNet
{
    ...
    {
		//private  static readonly string this.ConnStr = AppConfigurtaionServices.Configuration.GetConnectionString("conn");
		////ConfigurationManager.ConnectionStrings["this.ConnStr"].ConnectionString;

		//public static string this.ConnStr { get { return this.ConnStr; } }

		public DapperHelperSqlServer(string connStr)
		{
